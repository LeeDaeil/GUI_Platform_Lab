...
class body:
    def __init__(self):
        ...
        # ---------------------------------------------------------------------------------------- #
        from CNS_Monitoring_COMP.EX_interface import interface_function
        from CNS_Monitoring_COMP.EX_RUN_Module_FAST import RUN_FREEZE_FAST
        from CNS_Monitoring_COMP.EX_Module import EX_module
        pro_list = [RUN_FREEZE_FAST(self.shared_mem, IP=self.args.comip, Port=self.args.comport, tick=30),  # [1]
...
class generate_mem:
    ...
    def make_main_mem_structure(self, max_len_deque=10):
        from CNS_Monitoring_COMP.EX_db import db_make
    ...
    def make_mem_structure(self):
        ...
        memory_list = [Manager().dict(self.make_main_mem_structure(max_len_deque=2)),    # [0]
                       Manager().list(),                                                  # [1]
